...
public class GastoReparacionController {
    ...
    @PreAuthorize("hasAuthority('GESTOR_MANTENIMIENTO_AEROPUERTO')or hasAuthority('GESTOR_SERVICIOS_AERONAVES') or hasAuthority('AUDITOR_MANTENIMIENTO_AEROPUERTO') or hasAuthority('ADMINISTRADOR') ")
