...
public class BitacoraController {
    ...
    @PreAuthorize("hasAuthority('GERENTE_CONTROL_VUELO') or hasAuthority('AUDITOR_SERVICIOS_AERONAVES') or hasAuthority('AUDITOR_CONTROL_VUELOS') or hasAuthority('AUDITOR_MANTENIMIENTO_AEROPUERTO')  or hasAuthority('ADMINISTRADOR')")
    ...
    @ResponseBody
    @ApiOperation(value = "Obtiene una lista de bitácoras basada en el Id del usuario al que pertenece", response = BitacoraDto.class, tags = "Bitácoras")
    @PreAuthorize("hasAuthority('GERENTE_CONTROL_VUELO') or hasAuthority('AUDITOR_SERVICIOS_AERONAVES') "
            + "or hasAuthority('AUDITOR_CONTROL_VUELOS') or hasAuthority('AUDITOR_MANTENIMIENTO_AEROPUERTO')  "
    ...
    @PreAuthorize("hasAuthority('GERENTE_CONTROL_VUELO') or hasAuthority('ADMINISTRADOR') or hasAuthority('AUDITOR_SERVICIOS_AERONAVES') or"
            + " hasAuthority('AUDITOR_CONTROL_VUELOS') or hasAuthority('AUDITOR_MANTENIMIENTO_AEROPUERTO')")
